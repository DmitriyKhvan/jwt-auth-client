...
- Name: navigation.spec.ts >> Navigation >> should show error when clicking users without admin role
- Location: e2e\navigation.spec.ts:53:3
    ...
    - generic [ref=e104]:
      ...
      - generic [ref=e106]:
        - generic [ref=e107]:
          ...
          - textbox "Email" [ref=e109]: user@mail.ru
        - generic [ref=e110]:
          - generic [ref=e111]: Password
          - textbox "Password" [ref=e112]: 123456Q
        - button "Sign In" [ref=e113] [cursor=pointer]
        - link "Sign Up" [ref=e114] [cursor=pointer]:
          - /url: /sign-up
        - generic [ref=e115]: Cannot read properties of undefined (reading 'status')
```
